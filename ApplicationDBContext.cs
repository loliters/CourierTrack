...
namespace WebAppCourierTrack
{
    public class ApplicationDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TipoCliente>().HasIndex(tc => tc.Nombre).IsUnique();
            ...
            modelBuilder.Entity<TipoDocumento>().HasIndex(td => td.Nombre).IsUnique();
            ...
            modelBuilder.Entity<ExtensionCI>().HasIndex(e => e.Nombre).IsUnique();
            ...
            modelBuilder.Entity<EstadoPago>().HasIndex(ep => ep.Nombre).IsUnique();
            ...
            modelBuilder.Entity<DetallePedido>().HasData(
                new DetallePedido { Id = 1, Fecha = new DateTime(2025, 1, 10, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Documentos importantes", DireccionOrigenId = 1, DireccionDestinoId = 1 },
                new DetallePedido { Id = 2, Fecha = new DateTime(2025, 1, 11, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Caja mediana", DireccionOrigenId = 2, DireccionDestinoId = 2 },
                new DetallePedido { Id = 3, Fecha = new DateTime(2025, 1, 12, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Paquete pequeño frágil", DireccionOrigenId = 3, DireccionDestinoId = 3 },
                new DetallePedido { Id = 4, Fecha = new DateTime(2025, 1, 13, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Electrodoméstico", DireccionOrigenId = 4, DireccionDestinoId = 4 },
                new DetallePedido { Id = 5, Fecha = new DateTime(2025, 1, 14, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Equipos de oficina", DireccionOrigenId = 5, DireccionDestinoId = 5 },
                new DetallePedido { Id = 6, Fecha = new DateTime(2025, 1, 15, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Repuestos mecánicos", DireccionOrigenId = 6, DireccionDestinoId = 1 },
                new DetallePedido { Id = 7, Fecha = new DateTime(2025, 1, 16, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Medicamentos", DireccionOrigenId = 7, DireccionDestinoId = 2 },
                new DetallePedido { Id = 8, Fecha = new DateTime(2025, 1, 17, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Muebles pequeños", DireccionOrigenId = 8, DireccionDestinoId = 3 },
                new DetallePedido { Id = 9, Fecha = new DateTime(2025, 1, 18, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Papelería", DireccionOrigenId = 9, DireccionDestinoId = 4 },
                new DetallePedido { Id = 10, Fecha = new DateTime(2025, 1, 19, 0, 0, 0, DateTimeKind.Utc), Descripcion = "Material electrónico", DireccionOrigenId = 10, DireccionDestinoId = 5 }
            );
            ...
            modelBuilder.Entity<Calificacion>().HasData(
                ...
                new Calificacion { Id = 2, Comentario = "Muy buen servicio", Puntuacion = 4, Fecha = new DateTime(2025, 1, 11, 0, 0, 0, DateTimeKind.Utc), PedidoId = 2, ClienteId = 2, ConductorId = 2 },
                new Calificacion { Id = 3, Comentario = "Servicio aceptable", Puntuacion = 3, Fecha = new DateTime(2025, 1, 12, 0, 0, 0, DateTimeKind.Utc), PedidoId = 3, ClienteId = 3, ConductorId = 1 },
                new Calificacion { Id = 4, Comentario = "Buen trato", Puntuacion = 4, Fecha = new DateTime(2025, 1, 13, 0, 0, 0, DateTimeKind.Utc), PedidoId = 4, ClienteId = 4, ConductorId = 2 },
                new Calificacion { Id = 5, Comentario = "Entrega rápida", Puntuacion = 5, Fecha = new DateTime(2025, 1, 14, 0, 0, 0, DateTimeKind.Utc), PedidoId = 5, ClienteId = 5, ConductorId = 1 },
                new Calificacion { Id = 6, Comentario = "Podría mejorar", Puntuacion = 3, Fecha = new DateTime(2025, 1, 15, 0, 0, 0, DateTimeKind.Utc), PedidoId = 6, ClienteId = 6, ConductorId = 2 },
                new Calificacion { Id = 7, Comentario = "Muy satisfecho", Puntuacion = 5, Fecha = new DateTime(2025, 1, 16, 0, 0, 0, DateTimeKind.Utc), PedidoId = 7, ClienteId = 7, ConductorId = 1 },
                new Calificacion { Id = 8, Comentario = "Servicio regular", Puntuacion = 2, Fecha = new DateTime(2025, 1, 17, 0, 0, 0, DateTimeKind.Utc), PedidoId = 8, ClienteId = 8, ConductorId = 2 },
                new Calificacion { Id = 9, Comentario = "Buen conductor", Puntuacion = 4, Fecha = new DateTime(2025, 1, 18, 0, 0, 0, DateTimeKind.Utc), PedidoId = 9, ClienteId = 9, ConductorId = 1 },
                new Calificacion { Id = 10, Comentario = "Excelente atención", Puntuacion = 5, Fecha = new DateTime(2025, 1, 19, 0, 0, 0, DateTimeKind.Utc), PedidoId = 10, ClienteId = 10, ConductorId = 2 }
            );
            ...
            modelBuilder.Entity<Pago>().HasData(
                new Pago { Id = 1, Monto = 45.00m, Fecha = new DateTime(2025, 1, 10, 12, 0, 0, DateTimeKind.Utc), MetodoPagoId = 1, EstadoPagoId = 1, PedidoId = 1, Banco = "No Aplica", CuentaBancaria = "No Aplica", NumeroTransaccion = "No Aplica" },
                new Pago { Id = 2, Monto = 70.00m, Fecha = new DateTime(2025, 1, 11, 13, 0, 0, DateTimeKind.Utc), MetodoPagoId = 2, EstadoPagoId = 1, PedidoId = 2, Banco = "Banco Unión", CuentaBancaria = "10000045218", NumeroTransaccion = "TXN-85214" },
                new Pago { Id = 3, Monto = 30.00m, Fecha = new DateTime(2025, 1, 12, 14, 0, 0, DateTimeKind.Utc), MetodoPagoId = 1, EstadoPagoId = 1, PedidoId = 3, Banco = "No Aplica", CuentaBancaria = "No Aplica", NumeroTransaccion = "No Aplica" },
                new Pago { Id = 4, Monto = 120.00m, Fecha = new DateTime(2025, 1, 13, 15, 0, 0, DateTimeKind.Utc), MetodoPagoId = 2, EstadoPagoId = 1, PedidoId = 4, Banco = "Banco Nacional de Bolivia", CuentaBancaria = "201-514789", NumeroTransaccion = "TXN-96325" },
                new Pago { Id = 5, Monto = 95.00m, Fecha = new DateTime(2025, 1, 14, 16, 0, 0, DateTimeKind.Utc), MetodoPagoId = 1, EstadoPagoId = 2, PedidoId = 5, Banco = "No Aplica", CuentaBancaria = "No Aplica", NumeroTransaccion = "No Aplica" },
                new Pago { Id = 6, Monto = 110.00m, Fecha = new DateTime(2025, 1, 15, 17, 0, 0, DateTimeKind.Utc), MetodoPagoId = 2, EstadoPagoId = 1, PedidoId = 6, Banco = "Banco Mercantil Santa Cruz", CuentaBancaria = "402-369852", NumeroTransaccion = "TXN-14785" },
                new Pago { Id = 7, Monto = 22.00m, Fecha = new DateTime(2025, 1, 16, 18, 0, 0, DateTimeKind.Utc), MetodoPagoId = 1, EstadoPagoId = 1, PedidoId = 7, Banco = "No Aplica", CuentaBancaria = "No Aplica", NumeroTransaccion = "No Aplica" },
                new Pago { Id = 8, Monto = 175.00m, Fecha = new DateTime(2025, 1, 17, 19, 0, 0, DateTimeKind.Utc), MetodoPagoId = 2, EstadoPagoId = 3, PedidoId = 8, Banco = "Banco de Crédito BCP", CuentaBancaria = "305-784125", NumeroTransaccion = "TXN-36985" },
                new Pago { Id = 9, Monto = 58.00m, Fecha = new DateTime(2025, 1, 18, 20, 0, 0, DateTimeKind.Utc), MetodoPagoId = 1, EstadoPagoId = 1, PedidoId = 9, Banco = "No Aplica", CuentaBancaria = "No Aplica", NumeroTransaccion = "No Aplica" },
                new Pago { Id = 10, Monto = 88.00m, Fecha = new DateTime(2025, 1, 19, 21, 0, 0, DateTimeKind.Utc), MetodoPagoId = 2, EstadoPagoId = 2, PedidoId = 10, Banco = "Banco Económico", CuentaBancaria = "501-963258", NumeroTransaccion = "TXN-25814" }
            );
            modelBuilder.Entity<Pago>()
                .HasOne(p => p.Pedido)
                .WithMany()
            ...
            modelBuilder.Entity<Notificacion>().HasData(
                new Notificacion { Id = 1, Titulo = "Pedido Registrado", Mensaje = "Su pedido fue registrado correctamente.", Fecha = new DateTime(2025, 1, 10, 8, 5, 0, DateTimeKind.Utc), Leida = true, UsuarioId = 6, PedidoId = 1 },
                new Notificacion { Id = 2, Titulo = "Pedido Asignado", Mensaje = "Se asignó un conductor a su pedido.", Fecha = new DateTime(2025, 1, 11, 9, 5, 0, DateTimeKind.Utc), Leida = false, UsuarioId = 7, PedidoId = 2 },
                new Notificacion { Id = 3, Titulo = "En Camino", Mensaje = "Su pedido está siendo transportado.", Fecha = new DateTime(2025, 1, 12, 10, 5, 0, DateTimeKind.Utc), Leida = false, UsuarioId = 8, PedidoId = 3 },
                new Notificacion { Id = 4, Titulo = "Pedido Entregado", Mensaje = "Su pedido fue entregado exitosamente.", Fecha = new DateTime(2025, 1, 13, 11, 5, 0, DateTimeKind.Utc), Leida = true, UsuarioId = 9, PedidoId = 4 },
                new Notificacion { Id = 5, Titulo = "Pago Pendiente", Mensaje = "Tiene un pago pendiente por realizar.", Fecha = new DateTime(2025, 1, 14, 12, 5, 0, DateTimeKind.Utc), Leida = false, UsuarioId = 10, PedidoId = 5 },
                new Notificacion { Id = 6, Titulo = "Pago Confirmado", Mensaje = "Su pago fue confirmado correctamente.", Fecha = new DateTime(2025, 1, 15, 13, 5, 0, DateTimeKind.Utc), Leida = true, UsuarioId = 11, PedidoId = 6 },
                new Notificacion { Id = 7, Titulo = "Actualización", Mensaje = "El conductor está próximo a llegar.", Fecha = new DateTime(2025, 1, 16, 14, 5, 0, DateTimeKind.Utc), Leida = false, UsuarioId = 12, PedidoId = 7 },
                new Notificacion { Id = 8, Titulo = "Retraso", Mensaje = "Se registró un retraso en la entrega.", Fecha = new DateTime(2025, 1, 17, 15, 5, 0, DateTimeKind.Utc), Leida = false, UsuarioId = 6, PedidoId = 8 },
                new Notificacion { Id = 9, Titulo = "Entrega Exitosa", Mensaje = "Gracias por utilizar CourierTrack.", Fecha = new DateTime(2025, 1, 18, 16, 5, 0, DateTimeKind.Utc), Leida = true, UsuarioId = 7, PedidoId = 9 },
                new Notificacion { Id = 10, Titulo = "Pedido Finalizado", Mensaje = "El pedido fue completado satisfactoriamente.", Fecha = new DateTime(2025, 1, 19, 17, 5, 0, DateTimeKind.Utc), Leida = true, UsuarioId = 8, PedidoId = 10 }
            );

            modelBuilder.Entity<Seguimiento>().HasData(
                new Seguimiento { Id = 1, Fecha = new DateTime(2025, 1, 10, 8, 0, 0, DateTimeKind.Utc), Observacion = "Pedido registrado", PedidoId = 1, ConductorId = 1, VehiculoId = 1, UbicacionId = 1 },
                new Seguimiento { Id = 2, Fecha = new DateTime(2025, 1, 11, 9, 0, 0, DateTimeKind.Utc), Observacion = "Pedido asignado", PedidoId = 2, ConductorId = 2, VehiculoId = 2, UbicacionId = 2 },
                new Seguimiento { Id = 3, Fecha = new DateTime(2025, 1, 12, 10, 0, 0, DateTimeKind.Utc), Observacion = "En camino", PedidoId = 3, ConductorId = 1, VehiculoId = 1, UbicacionId = 3 },
                new Seguimiento { Id = 4, Fecha = new DateTime(2025, 1, 13, 11, 0, 0, DateTimeKind.Utc), Observacion = "Entregado", PedidoId = 4, ConductorId = 2, VehiculoId = 2, UbicacionId = 4 },
                new Seguimiento { Id = 5, Fecha = new DateTime(2025, 1, 14, 12, 0, 0, DateTimeKind.Utc), Observacion = "Confirmado", PedidoId = 5, ConductorId = 1, VehiculoId = 1, UbicacionId = 5 },
                new Seguimiento { Id = 6, Fecha = new DateTime(2025, 1, 15, 13, 0, 0, DateTimeKind.Utc), Observacion = "Pendiente de entrega", PedidoId = 6, ConductorId = 2, VehiculoId = 2, UbicacionId = 1 },
                new Seguimiento { Id = 7, Fecha = new DateTime(2025, 1, 16, 14, 0, 0, DateTimeKind.Utc), Observacion = "Retraso por tráfico", PedidoId = 7, ConductorId = 1, VehiculoId = 1, UbicacionId = 2 },
                new Seguimiento { Id = 8, Fecha = new DateTime(2025, 1, 17, 15, 0, 0, DateTimeKind.Utc), Observacion = "En reparto", PedidoId = 8, ConductorId = 2, VehiculoId = 2, UbicacionId = 3 },
                new Seguimiento { Id = 9, Fecha = new DateTime(2025, 1, 18, 16, 0, 0, DateTimeKind.Utc), Observacion = "Llegó al destino", PedidoId = 9, ConductorId = 1, VehiculoId = 1, UbicacionId = 4 },
                new Seguimiento { Id = 10, Fecha = new DateTime(2025, 1, 19, 17, 0, 0, DateTimeKind.Utc), Observacion = "Proceso finalizado", PedidoId = 10, ConductorId = 2, VehiculoId = 2, UbicacionId = 5 }
            );
            ...
            modelBuilder.Entity<UsuarioUbicacion>()
                ...
                .WithMany(u => u.UsuariosUbicaciones)
            ...
            modelBuilder.Entity<EstadoPedido>().HasData(
                new EstadoPedido { Id = 1, HoraCambio = new DateTime(2025, 1, 10, 8, 0, 0, DateTimeKind.Utc), PedidoId = 1, EstadoId = 4 },
                new EstadoPedido { Id = 2, HoraCambio = new DateTime(2025, 1, 11, 9, 0, 0, DateTimeKind.Utc), PedidoId = 2, EstadoId = 3 },
                new EstadoPedido { Id = 3, HoraCambio = new DateTime(2025, 1, 12, 10, 0, 0, DateTimeKind.Utc), PedidoId = 3, EstadoId = 4 },
                new EstadoPedido { Id = 4, HoraCambio = new DateTime(2025, 1, 13, 11, 0, 0, DateTimeKind.Utc), PedidoId = 4, EstadoId = 2 },
                new EstadoPedido { Id = 5, HoraCambio = new DateTime(2025, 1, 14, 12, 0, 0, DateTimeKind.Utc), PedidoId = 5, EstadoId = 1 },
                new EstadoPedido { Id = 6, HoraCambio = new DateTime(2025, 1, 15, 13, 0, 0, DateTimeKind.Utc), PedidoId = 6, EstadoId = 4 },
                new EstadoPedido { Id = 7, HoraCambio = new DateTime(2025, 1, 16, 14, 0, 0, DateTimeKind.Utc), PedidoId = 7, EstadoId = 3 },
                new EstadoPedido { Id = 8, HoraCambio = new DateTime(2025, 1, 17, 15, 0, 0, DateTimeKind.Utc), PedidoId = 8, EstadoId = 5 },
                new EstadoPedido { Id = 9, HoraCambio = new DateTime(2025, 1, 18, 16, 0, 0, DateTimeKind.Utc), PedidoId = 9, EstadoId = 4 },
                new EstadoPedido { Id = 10, HoraCambio = new DateTime(2025, 1, 19, 17, 0, 0, DateTimeKind.Utc), PedidoId = 10, EstadoId = 10 }
            );
