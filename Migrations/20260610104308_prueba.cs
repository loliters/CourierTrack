    ...
    public partial class prueba : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 9, "Buen servicio empresarial", new DateTime(2025, 1, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, 11 },
                    { 10, "Entrega satisfactoria", new DateTime(2025, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, 12 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, "Av. Ballivián, esquina semáforo", 6 },
                    { 7, "Terminal de buses, ingreso principal", 7 },
                    { 8, "Av. Camacho, edificio empresarial", 8 },
                    { 9, "Zona Miraflores, frente al estadio", 9 },
                    { 10, "Calle 21 de Calacoto, esquina farmacia", 10 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Excelente servicio", new DateTime(2025, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 3 },
                    { 2, "Entrega rápida y segura", new DateTime(2025, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, 4 },
                    { 3, "Buen trato del conductor", new DateTime(2025, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 5 },
                    { 4, "El pedido llegó tarde", new DateTime(2025, 1, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 6 },
                    { 5, "Servicio aceptable", new DateTime(2025, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, 7 },
                    { 6, "El paquete llegó en buen estado", new DateTime(2025, 1, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 8 },
                    { 7, "Faltó comunicación durante la entrega", new DateTime(2025, 1, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 9 },
                    { 8, "Muy recomendado", new DateTime(2025, 1, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 10 }
                });
            ...
            migrationBuilder.InsertData(
                table: "ClientesJuridicos",
                columns: new[] { "Id", "ClienteId", "Nit", "RazonSocial" },
                values: new object[] { 1, 8, "1020304011", "Courier Express SRL" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(1995, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 2, new DateTime(1998, 7, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 },
                    { 3, 3, new DateTime(1992, 11, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 4, 4, new DateTime(2000, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 },
                    { 5, 5, new DateTime(1997, 9, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 10, 8, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 2, new DateTime(2025, 1, 10, 10, 30, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 3, 3, new DateTime(2025, 1, 10, 13, 15, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 4, 1, new DateTime(2025, 1, 12, 9, 0, 0, 0, DateTimeKind.Unspecified), 2 },
                    { 5, 2, new DateTime(2025, 1, 12, 12, 20, 0, 0, DateTimeKind.Unspecified), 2 },
                    { 6, 3, new DateTime(2025, 1, 12, 15, 45, 0, 0, DateTimeKind.Unspecified), 2 },
                    { 7, 1, new DateTime(2025, 1, 15, 8, 45, 0, 0, DateTimeKind.Unspecified), 3 },
                    { 8, 4, new DateTime(2025, 1, 15, 11, 15, 0, 0, DateTimeKind.Unspecified), 3 },
                    { 9, 1, new DateTime(2025, 1, 18, 7, 50, 0, 0, DateTimeKind.Unspecified), 4 },
                    { 10, 2, new DateTime(2025, 1, 18, 11, 40, 0, 0, DateTimeKind.Unspecified), 4 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TipoLicencias_Categoria",
                table: "TipoLicencias",
                column: "Categoria",
                unique: true);
